...
public class MyUnsortedList<E> implements UnsortedList<E> {
    ...
    public boolean equals(Object obj) {
        ...
        while (thisLink != null) {
        	/* thatLink could never be null:
        	 * the method insert and prepend are creating by 
        	 * themselves the Link object they need.
        	 * And the methods remove and pop are removing by themselves
        	 * the Link objects. There is no way that thatLink can be null by
        	 * our fault.
        	 * 
        	 */
